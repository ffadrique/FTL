module xxmodulebase___vector_ftl
...
!---Public/Private declarations-------------------------------------------------
  ...
  public xxtypebase___vector_ftl, xxconstructor___vector_ftl
  public xxtypebase___vector_ftl_iterator
...
! Vector container type
  type, extends(t_object) :: xxtypebase___vector_ftl
    private
...
!     Memory allocation management
  ...
  end type xxtypebase___vector_ftl
...
! Reference vector size parameters
  ...
  interface xxconstructor___vector_ftl
  ...
  end interface xxconstructor___vector_ftl
...
! Interface to provide user comparison functions
  abstract interface
    pure function comparison( from_vector, reference ) result(res)
      use xxuse__
      class(xxtypebase__), intent(in) :: from_vector
...
! Vector iterator type
  type, extends(t_object) :: xxtypebase___vector_ftl_iterator
    private
...
!   Pointer to the container vector
    type(xxtypebase___vector_ftl), pointer :: parent => null()
...
!     Comparison operators
  ...
  end type xxtypebase___vector_ftl_iterator
...
! The result vector
  type(xxtypebase___vector_ftl) :: res
...
! Iterator to first node to insert
  class(xxtypebase___vector_ftl_iterator), intent(in) :: first

! Iterator to last node to insert
  class(xxtypebase___vector_ftl_iterator), intent(in) :: last
...
! The input vector
  type(xxtypebase___vector_ftl), intent(in) :: other
...
! The output vector
  class(xxtypebase___vector_ftl), intent(out) :: this
...
! The vector
  class(xxtypebase___vector_ftl), target, intent(in) :: this

! Pointer to beginning of the vector
  type(xxtypebase___vector_ftl_iterator) :: res
...
! The vector
  class(xxtypebase___vector_ftl), intent(in) :: this
...
! Local variables
  type(xxtypebase___vector_ftl_iterator) :: it
  integer :: i, n
...
! The vector
  class(xxtypebase___vector_ftl), target, intent(inout) :: this

! Iterator to node used as reference for insertion
  class(xxtypebase___vector_ftl_iterator), intent(in) :: iterator
...
! Iterator to node used as reference for insertion
  type(xxtypebase___vector_ftl_iterator), intent(in) :: iterator

! Iterator to first node to insert
  type(xxtypebase___vector_ftl_iterator), intent(in) :: first

! Iterator to last node to insert
  type(xxtypebase___vector_ftl_iterator), intent(in) :: last
...
! Iterator to node to remove
  class(xxtypebase___vector_ftl_iterator), intent(inout) :: iterator
...
! The vector to swap
  type(xxtypebase___vector_ftl), intent(inout) :: other

! Local variables
  class(xxtypebase__), pointer :: tmpe
  integer :: i, n
...
! The position in vector to insert the elements
  class(xxtypebase___vector_ftl_iterator), intent(in) :: position

! The source vector
  class(xxtypebase___vector_ftl), intent(inout) :: source
...
! The element position in source
  class(xxtypebase___vector_ftl_iterator), intent(in) :: it
...
! the vector to swap
  type(xxtypebase___vector_ftl), target, intent(inout) :: other
...
! Local pointer
  class(xxtypebase__), pointer :: tmp_ptr
...
! Iterator to first element
  class(xxtypebase___vector_ftl_iterator), intent(inout) :: iter1

! Iterator to second element
  type(xxtypebase___vector_ftl_iterator), intent(inout) :: iter2
...
! The vector to search
  type(xxtypebase___vector_ftl), intent(in) :: this
...
! the vector iterator
  class(xxtypebase___vector_ftl_iterator), intent(in) :: this
...
! The first node
  class(xxtypebase___vector_ftl_iterator), intent(in) :: origin

! The final node
  class(xxtypebase___vector_ftl_iterator), intent(in) :: target
...
! The vector iterator
  class(xxtypebase___vector_ftl_iterator), intent(inout) :: this
...
! The output iterator
  class(xxtypebase___vector_ftl_iterator), intent(out) :: left

! The input iterator
  class(xxtypebase___vector_ftl_iterator), intent(in) :: right
...
! The first iterator
  class(xxtypebase___vector_ftl_iterator), intent(in) :: left
...
end module xxmodulebase___vector_ftl
