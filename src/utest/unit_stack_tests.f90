...
! Synopsis  : Unit tests for xxtypebase___stack_ftl
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public unit_stack_suite_before
  public unit_stack_suite_after

  public unit_stack_before_001
  public unit_stack_test_001
  public unit_stack_after_001

  public unit_stack_before_002
  public unit_stack_test_002
  public unit_stack_after_002

  public unit_stack_before_003
  public unit_stack_test_003
  public unit_stack_after_003
...
!---End of public/private declarations------------------------------------------
  ...
  character(len=*), parameter :: module = 'stack'
...
! List of object used as reference for the stack
...
subroutine unit_stack_before_001( ut )
...
end subroutine unit_stack_before_001

! ############################################################################

subroutine unit_stack_test_001( ut )

! The unit test
  class(t_xfunit_unit), intent(inout) :: ut

! The tested strcuture
  type(xxtypebase___stack_ftl) :: o, oo
...
! Copy constructor
  oo = xxconstructor___stack_ftl(o)
...
end subroutine unit_stack_test_001

! ############################################################################

subroutine unit_stack_after_001( ut )
...
end subroutine unit_stack_after_001

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_stack_before_002( ut )
...
end subroutine unit_stack_before_002

! ############################################################################

subroutine unit_stack_test_002( ut )
...
! Add one element
  ...
  call ut%assert_equal( 'Push one element (top)', o%top(), elements(1), ecompare, eserialize )
  call ut%assert_equal( 'Push one element (bottom)', o%bottom(), elements(1), ecompare, eserialize )
...
! Add few elements
  ...
  call ut%assert_equal( 'Push few elements (top)', o%top(), elements(5), ecompare, eserialize )
  call ut%assert_equal( 'Push few elements (bottom)', o%bottom(), elements(1), ecompare, eserialize )
  allocate( oarray, source=o%array() )
...
! Remove two elements
  ...
  call ut%assert_equal( 'Pop two elements (top)', o%top(), elements(3), ecompare, eserialize )
  call ut%assert_equal( 'Pop two elements (bottom)', o%bottom(), elements(1), ecompare, eserialize )
  deallocate( oarray )
  allocate( oarray, source=o%array() )
  call ut%assert_equal( 'Pop two elements', oarray, elements(1:3), ecompare, eserialize )

! Clear stack
  call o%clear()
  call ut%assert_equal( 'Clear stack (size)', o%size(), 0 )
...
end subroutine unit_stack_test_002

! ############################################################################

subroutine unit_stack_after_002( ut )
...
end subroutine unit_stack_after_002

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_stack_before_003( ut )
...
end subroutine unit_stack_before_003

! ############################################################################

subroutine unit_stack_test_003( ut )
...
end subroutine unit_stack_test_003

! ############################################################################

subroutine unit_stack_after_003( ut )
...
end subroutine unit_stack_after_003

! ############################################################################
! # Suite before procedure ###################################################
! ############################################################################

subroutine unit_stack_suite_before( suite )
...
! Create the reference array of elements for the stack
  do i = 1, size(elements)
      elements(i) = cxxtypebase__( i, real(i,8), character(i,fmt='(i4.4)'))
  end do

end subroutine unit_stack_suite_before

! ############################################################################
! # Suite after procedure ####################################################
! ############################################################################

subroutine unit_stack_suite_after( suite )

! Reference suite
  class(t_xfunit_suite), intent(inout) :: suite


end subroutine unit_stack_suite_after
