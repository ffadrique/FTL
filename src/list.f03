...
! Iterator to node to remove
  class(xxtypebase___list_ftl_iterator), intent(inout) :: iterator
...
! The list to swap
  type(xxtypebase___list_ftl), intent(inout) :: other
...
! The position in list to insert the elements
  class(xxtypebase___list_ftl_iterator), intent(in) :: position

! The source list
  class(xxtypebase___list_ftl), intent(inout) :: source
...
! The element position in source
  class(xxtypebase___list_ftl_iterator), intent(in) :: it
...
! Local iterators
  type(xxtypebase___list_ftl_iterator) :: it, itnext
...
! The list
  class(xxtypebase___list_ftl), target, intent(inout) :: this
...
! The list to merge
  type(xxtypebase___list_ftl), target, intent(inout) :: other
...
! Iterator to first element
  class(xxtypebase___list_ftl_iterator), intent(inout) :: iter1

! Iterator to second element
  class(xxtypebase___list_ftl_iterator), intent(inout) :: iter2
...
! The list iterator
  class(xxtypebase___list_ftl_iterator), intent(in) :: this
...
! The final list iterator
  class(xxtypebase___list_ftl_iterator), intent(in) :: target
...
! The list iterator
  class(xxtypebase___list_ftl_iterator), intent(inout) :: this
...
! The output iterator
  class(xxtypebase___list_ftl_iterator), intent(out) :: left

! The input iterator
  class(xxtypebase___list_ftl_iterator), intent(in) :: right
...
! The first iterator
  class(xxtypebase___list_ftl_iterator), intent(in) :: left
...
end module xxmodulebase___list_ftl
